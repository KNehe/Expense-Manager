...
class _WeekMonthState extends State<WeekMonth> {
  ...
  void initState() {
    ...
    _getWeekExpenses = DatabaseService()
        .getWeekDataFromRange(weekMonthData: widget.weekMonthData);
    _getWeekIncome = DatabaseService()
        .getWeekTotalIncome(weekMonthData: widget.weekMonthData);
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text('${widget.weekMonthData.weekName}'),
        ),
        body: Column(
          children: <Widget>[
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  CustomText(
                    text:
                        'Total expenditure : ${widget.weekMonthData.expenditure}',
                            ...
                            return Row(
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: CustomText(
                                    text:
                                        '${data[index].dateRecorded} ${data[index].timeRecorded}',
                                    textColor: Colors.black,
                                    fontFamily: 'open sans',
                                    fontWeight: FontWeight.w700,
                                    fontSize: 15.0,
